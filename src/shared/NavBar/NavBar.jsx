...
const NavBar = () => {
  ...
  return (
    <div className={color ? 'sticky bg-[#12312e] top-0 z-50 duration-300 shadow-md py-1' : 'pt-0 shadow-sm border-b border-[#40fe5c1f] navBg bg-gradient-to-r from-[#043814] to-[#061B09] duration-300'}>
