    ...
    <div className="mt-32">
      ...
      <div className="lg:flex justify-between mt-20">
        ...
        <div className='lg:w-1/2 flex justify-start relative'>
          ...
          <img src={earthImg} alt="Image" className='w-[110px] md:w-[200px] lg:w-[140px] xl:w-[190px] 2xl:w-[240px] absolute bottom-[200px] md:bottom-[378px] lg:bottom-[387px] xl:bottom-[365px] 2xl:bottom-[265px] left-4 md:left-7 lg:left-3 xl:left-5 2xl:left-9' />
        </div>

        {/* Sat wear */}
        <div className="lg:2/3 xl:w-3/3 2xl:w-3/3">
          <div className="max-w-[1620px] mx-auto 2xl:pr-[250px] xl:pr-24 lg:pr-16 md:pr-10 sm:pr-2 pr-4">
            ...
            <div className="border-y border-[#074933] py-10">
              <div className="flex justify-between gap-x-32 2xl:gap-x-64 ml-16">
            ...
            <div className="border-y border-[#074933] py-10 relative">
              <div className="flex justify-between gap-x-32 2xl:gap-x-64 ml-16 z-30">
                <div className="font-inter">
