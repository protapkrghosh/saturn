      ...
      <Container>
        <div className='lg:flex relative'>
          ...
          <div className='lg:w-[50%] md:w-[80%]'>
            ...
            <img className='lg:w-[110px] xl:w-[140px] 2xl:w-[150px] absolute lg:left-[72px] xl:left-[125px] 2xl:left-[175px] lg:bottom-[415px] xl:bottom-[332px] 2xl:bottom-[304px]' src={earth} alt="image" />
          </div>
