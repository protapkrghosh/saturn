      ...
      <Container>
        <div className='lg:flex relative'>
          ...
          <div className='lg:w-[50%] md:w-[80%]'>
            ...
            <img className='w-[90px] md:w-[125px] lg:w-[110px] xl:w-[140px] 2xl:w-[150px] absolute left-[134px] md:left-[290px] lg:left-[72px] xl:left-[125px] 2xl:left-[175px] bottom-[781px] md:bottom-[905px] lg:bottom-[415px] xl:bottom-[332px] 2xl:bottom-[304px]' src={earth} alt="image" />
          </div>
