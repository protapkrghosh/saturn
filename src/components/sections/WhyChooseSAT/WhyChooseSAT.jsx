        ...
        <div className='lg:flex gap-[50px]'>
          ...
          <div className='bg-[#06201b10] border border-[#074933] border-b-0 rounded-[15px] rounded-b-none lg:w-1/2 mb-16 lg:mb-0'>
            <div className='relative'>
              <p className='text-[#FFF] font-inter text-[60px] lg:text-[44px] xl:text-[55px] 2xl:text-[60px] font-bold mt-[80px] 2xl:ml-20 xl:ml-7 text-center'>Why Choose <span className='text-[#40FE5B]'>$SAT</span></p>
