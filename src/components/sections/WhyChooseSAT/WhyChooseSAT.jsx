        ...
        <div className='grid grid-cols-2 gap-[50px]'>
          ...
          <div className='bg-[#06201b10] border border-[#074933] border-b-0 rounded-[15px] rounded-b-none'>
            <div className='relative'>
              ...
              <img className='absolute 2xl:w-[650px] xl:w-[510px] lg:w-[375px] 2xl:top-[170px] xl:top-[265px] lg:top-[415px] 2xl:left-[15px] xl:left-[20px] lg:left-[20px]' src={whyChooseImg} alt="" />
