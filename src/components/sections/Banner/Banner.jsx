...
const Banner = () => {
  return (
    <div className='relative overflow-hidden'>
      ...
      {/* Path */}
      <img src={moonImg} alt="Image" className='absolute top-0 left-0 -mt-20' />
      <img src={shapeImg} alt="Image" className='absolute top-0 left-0' />
      <img src={pathImg} alt="Image" className='opacity-[0.08] absolute top-0 left-0' />

      <div>
        <Container>
          <div className='pt-[150px] pb-[300px] 2xl:pt-[180px]'>
