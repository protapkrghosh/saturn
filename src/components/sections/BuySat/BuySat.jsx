            ...
            <div className='md:flex justify-between items-center'>
              ...
              <div className='md:w-1/2 font-inter'>
                <div className="flex items-center">
                  <p className='text-white text-[20px] font-semibold px-12 py-[38px] border border-[#074933] rounded-[100px] bg-[#06291B]'>Click on Buy Button</p>
              ...
              <div className="md:w-1/2">
                <div className="flex justify-between items-center border-[2px] border-[#074933] rounded-[90px] py-5 px-12">
                  <p className="text-[#F4F4F4] font-normal w-[90%]">Ready to invest in the next big thing? Head to our buy section now and grab your share of the $SAT coin revolution. Don't miss out on the moon ride!</p>
